...
## IPTables rules
The file `/etc/iptables/rules.v4`
```
# Generated by iptables-save v1.8.10 (nf_tables) on Fri Nov 14 11:19:40 2025
*filter
:INPUT ACCEPT [0:0]
:FORWARD DROP [0:0]
:OUTPUT ACCEPT [0:0]
-A FORWARD -d 10.99.0.2/32 -i ens6 -o wg0 -m conntrack --ctstate NEW,RELATED,ESTABLISHED -j ACCEPT
-A FORWARD -i wg0 -o ens6 -m conntrack --ctstate RELATED,ESTABLISHED -j ACCEPT
COMMIT
# Completed on DATE
# Generated by iptables-save v1.8.10 (nf_tables) on DATE
*nat
:PREROUTING ACCEPT [5:416]
:INPUT ACCEPT [0:0]
:OUTPUT ACCEPT [0:0]
:POSTROUTING ACCEPT [0:0]
-A PREROUTING -i ens6 -p tcp -m tcp ! --dport 22 -j DNAT --to-destination 10.0.0.2
-A PREROUTING -i ens6 -p udp -m udp ! --dport 55107 -j DNAT --to-destination 10.0.0.2
COMMIT
# Completed on DATE
```
